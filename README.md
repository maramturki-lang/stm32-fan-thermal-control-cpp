...
> `Mini_Projet_CPP_STM32411.ioc` (ouvrable avec STM32CubeMX / STM32CubeIDE).
...
│   ├── STM_Gpiogroupe.cpp  abstraction d'un groupe de broches GPIO
...
|---|---|
| `STM_Gpiogroupe` | Configuration et manipulation d'un ensemble de broches |
